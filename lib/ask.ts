...
const CAR_PROFILE = `МАШИНА ВЛАДЕЛЬЦА (зафиксировано, не уточняй):
- Марка/модель: Chevrolet Orlando
- Год выпуска: 2012
- Двигатель: 1.8 БЕНЗИН (F18D4 / LUW), а НЕ дизель. Если в вопросе путают с 2.0 дизелем — поправляй.
- КПП: АВТОМАТ 6T40 (АКПП), а НЕ механика.
- ГРМ: цепь (с натяжителем и фазорегулятором)
- Привод: передний

Все рекомендации давай для ИМЕННО этой комплектации. Не предполагай альтернативы (дизель/механика) без явной просьбы.`;
...
1) Твои общие знания о Chevrolet Orlando 1.8 АКПП 2012 (двигатель F18D4 / LUW, АКПП 6T40, цепь ГРМ, типичные болезни — VVT-клапаны, теплообменник, прокладка клапанной крышки).
